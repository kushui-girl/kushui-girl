$('.start').click(function(){
    ...
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','天哥，生日快乐呀！今年继续来DIY个属于自己的生日蛋糕吧！');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 3){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','搅拌成功!','恭喜你，搅拌的很完美！接下来就是放入烤箱进行烘焙了。');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','烘焙成功!','OK，非常完美!你已经是个合格的面点师了。下面就是在蛋糕胚上加入果酱、奶油进行自由搭配啦。');
    }
})
